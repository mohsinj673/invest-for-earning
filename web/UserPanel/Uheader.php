...
if(!isset($_SESSION['MyUser'])){
	echo "<script>alert('Login First');window.location.href='../FrontTheme/home.php';</script>";
}
?>
...
$userObj = new Users();
$email = $_SESSION['MyUser'];

$userData = $userObj->getUserByEmail($email);
						...
						<div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
							...
							<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark ">
								...
								while($users = mysqli_fetch_array($userData))  
                					{  
								?>
								<h3 style="margin-top: 25px;"><marquee>Welcome <?php echo ucfirst($users["name"]);?> From Pakistan | Get News and Updates</marquee></h3>
											...
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<?php
																 if($users["img"] == ""){
																 	?>
																 	<img src="assets/app/media/img/users/nobody.jpg" alt="" height="50" width="50" />
																 <?php
																}else{
																	?>
																	<img src="assets/app/media/img/users/<?php echo $users["img"]?>" alt="" />
																<?php
																}//else block
																?>
												</span>
														...
														<div class="m-card-user m-card-user--skin-dark">
															<div class="m-card-user__pic">
																...
																<?php
																 if($users["img"] == ""){
																 	?>
																 	<img src="assets/app/media/img/users/nobody.jpg" alt="" height="70" width="70" />
																 <?php
																}else{
																	?>
																	<img src="assets/app/media/img/users/<?php echo $users["img"]?>" alt="" />
															...
															<div class="m-card-user__details">
																<span class="m-card-user__name m--font-weight-500"><?php echo $users["name"] ?></span>
																<a href="" class="m-card-user__email m--font-weight-300 m-link"><?php echo ucfirst($users["email"]); ?></a>					
															</div>
															<?php
															}//while end
															?>
														...
														<div class="m-dropdown__content">
															<ul class="m-nav m-nav--skin-light">
																...
																<li class="m-nav__item">
																	<a href="MyProfile.php" class="m-nav__link">
